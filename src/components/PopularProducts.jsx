...
const PopularProducts = ({ coffees, setCoffees }) => {
    ...
    return (
        ...
        <div className='my-20 bg-popular-bg bg-no-repeat'>
            <p className='text-center text-lg'>--- Sip & Savor ---</p>
            <h2 className='text-5xl text-center font-semibold text-[#331A15] bg-popular-bg2 bg-right-bottom'>Our Popular Products</h2>
